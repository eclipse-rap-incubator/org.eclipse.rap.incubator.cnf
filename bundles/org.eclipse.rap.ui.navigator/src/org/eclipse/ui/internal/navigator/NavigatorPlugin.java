...
public class NavigatorPlugin extends AbstractUIPlugin {
	...
	// RAP
	/** The id of the org.eclipse.rap.ui.navigator plugin. */
	public static String PLUGIN_ID = "org.eclipse.rap.ui.navigator"; //$NON-NLS-1$

	/**
	 * The id of the org.eclipse.ui.navigator plug-in
	 */
	public static String NAVIGATOR_PLUGIN_ID = "org.eclipse.ui.navigator"; //$NON-NLS-1$
	// /RAP
